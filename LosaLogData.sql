/*
 ...
 Source Server         : ArchorSaga
 Source Server Type    : SQL Server
 Source Server Version : 15002000
 Source Host           : localhost:1691
...
CREATE PROCEDURE [dbo].[log_trace_prisoner_option_add]
	...
	@BLUE_MAX_MEMBER		INT,
	@RED_MAX_MEMBER			INT,
	@TEAM_RANDOM_MODE INT,
	@CLOSED_ROOM_OPTION INT,
	@TEAM_MIX_OPTION		INT
...
AS
	...
	INSERT INTO dbo.log_trace_prisoner_option (BlueMember, RedMember, BlueMaxMember, RedMaxMember, TeamMixOption, closedRoomOption, roomNumber,teamRandomMode, RegDate)
	VALUES (@BLUE_MEMBER, @RED_MEMBER, @BLUE_MAX_MEMBER, @RED_MAX_MEMBER, @TEAM_MIX_OPTION,@CLOSED_ROOM_OPTION,@ROOM_NUMBER,@TEAM_RANDOM_MODE,  GETDATE())
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[GAME_LOG]', RESEED, 9629366)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_class]', RESEED, 138170)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_costume]', RESEED, 4059)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_decoration]', RESEED, 951946)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_equip]', RESEED, 1069182)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_gold]', RESEED, 34100)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_special]', RESEED, 4464324)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_cardmatching]', RESEED, 22552)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_character]', RESEED, 2398384)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_cheating]', RESEED, 38367)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_clover]', RESEED, 1116251)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_custom_medal]', RESEED, 30425)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_excavating_new]', RESEED, 541921)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_gear_upgrade]', RESEED, 2855323)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_localinfo]', RESEED, 103485)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_matchmode2]', RESEED, 1554)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_medal]', RESEED, 223674)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_medal_extend]', RESEED, 3417)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_oakbarrel]', RESEED, 3836)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_pcroom]', RESEED, 235433)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_peso]', RESEED, 7673706)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_pet]', RESEED, 431935)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_piece_divide]', RESEED, 112670)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_play]', RESEED, 843052)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_quest]', RESEED, 2142955)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_roominfo]', RESEED, 443293)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_spirit_change]', RESEED, 22344)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_spirit_divide]', RESEED, 2823)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_spirit_mix]', RESEED, 455)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_spirit_obtain]', RESEED, 59584)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_spirit_peso]', RESEED, 4)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_time]', RESEED, 1147830)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_trade]', RESEED, 4109)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_event_bingo]', RESEED, 239917)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[Log_game_concurrent]', RESEED, 457947)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_present]', RESEED, 8144159)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_trace_prisoner_option]', RESEED, 28940)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_trace_prisoner_start]', RESEED, 16077)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[SQL_ERROR_LOG]', RESEED, 567640)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[TBL_LOG_HACK]', RESEED, 7741)
GO
