...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_class_buytime]', RESEED, 3007)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_guild_mark]', RESEED, 742)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_level_playtime]', RESEED, 4884)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_mannerpoint]', RESEED, 161)
GO
